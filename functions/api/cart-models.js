/** GET|POST /api/cart-models?makeKeys=denago,evolution — models for the given makes. */
...
export const onRequestGet = ({ request }) => handle(request, "/get-cart-models");
export const onRequestPost = ({ request }) => handle(request, "/get-cart-models");
